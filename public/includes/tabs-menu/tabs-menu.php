...
<div class="menu-container">
    <div class="tabs-menu">
        <button class="tabs-button tabs-selected" id="tabs-starters"><i class="fa-solid fa-bowl-food"></i>Entrée</button>
...
<script type="module" src="includes/tabs-menu/tabs-menu.js"></script>
